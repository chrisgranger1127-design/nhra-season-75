...
const QUALIFYING = {
  3: { // Winternationals · Apr 9-12 · Pomona CA
    tf: {
      ...
      sessions: {
        1: [ // Q1 only — Friday 2:30 PM PT first session order
        ...
        2: [ // Q2 combined best — Pruett improved to 3.724, moves to P1
    ...
    fc: {
      ...
      sessions: {
        ...
        2: [ // Q2 combined best — Vandergriff improved to 3.951, moves to P1
